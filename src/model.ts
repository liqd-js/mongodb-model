...
>
{
    ...
    protected async pipeline( options: ModelAggregateOptions<DBE, SmartFilters> ): Promise<Document[]>
    {
    ...
    public async list<K extends keyof Extensions['converters']>(list: ModelListOptions<DBE, SmartFilters>, conversion: K = 'dto' as K ): Promise<WithTotal<Array<Awaited<ReturnType<Extensions['converters'][K]['converter']>> & { $cursor?: string }>>>
    {
    ...
    public async aggregate<T>( pipeline: Document[], options?: ModelAggregateOptions<DBE, SmartFilters> ): Promise<T[]>
    {
    ...
    public async count( pipeline: Document[], options?: ModelAggregateOptions<DBE, SmartFilters> ): Promise<number>
    {
